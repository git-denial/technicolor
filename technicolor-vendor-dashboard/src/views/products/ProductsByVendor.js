...
const Products = ({match}) => {
  ...
  const getProducts = async () => {
    ...
    try {
      let result = await productModel.getByVendor(match.params.vendorId);
      console.log(result);
      setProducts(result)
    } catch (e) {
      console.log(e);
  ...
  const getVendor = async () => {
    ...
    try{
      let result = await vendorModel.getById(match.params.vendorId);
      console.log(result);
      setVendor(result);
    }catch (e) {
      console.log(e);
        ...
        Opsi: (item) => (
          <td>
              <CButton
                ...
                color="warning"
                onClick={()=>{
                  history.push('/my-product/update/' + item.id);
                }}
              >
                Edit
              </CButton>
            ...
            <CButton
              ...
              onClick={async () => {
                ...
                try {
                  ...
                  let result = await productModel.delete(item.id);
                  console.log(result);
